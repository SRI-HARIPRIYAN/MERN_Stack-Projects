...
const BookModal = ({ item, onClose }) => {
	return (
		...
		>
			...
			>
				<AiOutlineClose
					className="absolute right-6 top-6 text-3xl text-red-600   "
					onClick={onClose}
				/>
				...
				<p className="my-2">
					...
					Quaerat reprehenderit ullam esse maxime odit animi placeat
					dolore, non labore beatae accusamus fugiat architecto
					delectus alias fugit sunt nisi fuga magni.
				</p>
			</div>
		</div>
	);
